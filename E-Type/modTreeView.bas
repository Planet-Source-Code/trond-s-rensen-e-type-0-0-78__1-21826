...
Sub AddDocToGroup(ByVal trv As TreeView, ByVal Name As String)
'Dim Name As String
Dim Person As Node
Dim Group As Node

'    Name = frmFavorites.lwFiles.SelectedItem.SubItems(1)
    If Name = "" Then Exit Sub
    If Right(Name, 14) = "File not saved" Then
