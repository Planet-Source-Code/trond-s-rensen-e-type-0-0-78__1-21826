...
'  called frmMDI. A child form, called DocMaster, which contains a RTB. It is from
...
Private Sub Form_Load()
    ...
    sPrintText = frmMDI.ActiveForm.Text1.Text
    ...
    frmMDI.ActiveForm.rtfTmp.Text = sPrintText
    ...
    DocWYSIWYG frmMDI.ActiveForm.rtfTmp
    ...
    '   frmMDI.ActiveForm.ActiveControl.SelPrint frmDocPreview.picX.Hdc
...
Sub FormPreviewPage(inControl As Control, InPage As Integer)
    ...
    TextLength = Len(frmMDI.ActiveForm.rtfTmp.Text)

    PageCtn = 1
    Do
        newStartPos = SendMessage(frmMDI.ActiveForm.rtfTmp.hwnd, EM_FORMATRANGE, True, mFormatRange)
...
Sub DocPrintProc()
    ...
    Set mydialog1 = frmMDI.CMDialog1
    ...
    If frmMDI.ActiveForm.rtfTmp.SelLength = 0 Then
    ...
    If frmMDI.ActiveForm.WindowState <> 1 Then
        DocWYSIWYG frmMDI.ActiveForm.rtfTmp
        frmMDI.ActiveForm.Move 0, 0
    Else
