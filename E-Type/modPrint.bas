...
'Demonstrates the use of the new VB6 Replace Funtion
    sText = Replace(sText, "^N", StripPath(frmMDI.ActiveForm.Caption))
    sText = Replace(sText, "^n", StripPath(frmMDI.ActiveForm.Caption))
    sText = Replace(sText, "^P", frmMDI.ActiveForm.Caption)
    sText = Replace(sText, "^p", frmMDI.ActiveForm.Caption)
...
'Replace Control keys with actual text
    Select Case pPaperSize
        Case 1
            pPaperSize = "Letter, 8 1/2 x 11 in."
        Case 2
            pPaperSize = "Letter Small, 8 1/2 x 11 in."
        Case 3
            pPaperSize = "Tabloid, 11 x 17 in."
        Case 4
            pPaperSize = "Ledger, 17 x 11 in."
        Case 5
            pPaperSize = "Legal, 8 1/2 x 14 in."
        Case 6
            pPaperSize = "Statement, 5 1/2 x 8 1/2 in."
        Case 7
            pPaperSize = "Executive, 7 1/2 x 10 1/2 in."
        Case 8
        ...
        Case 14
            pPaperSize = "Folio, 8 1/2 x 13 in."
        Case 15
        ...
        Case 18
            pPaperSize = "Note, 8 1/2 x 11 in."
        Case 19
            pPaperSize = "Envelope #9, 3 7/8 x 8 7/8 in."
        Case 20
            pPaperSize = "Envelope #10, 4 1/8 x 9 1/2 in."
        Case 21
            pPaperSize = "Envelope #11, 4 1/2 x 10 3/8 in."
        Case 22
            pPaperSize = "Envelope #12, 4 1/2 x 11 in."
        Case 23
            pPaperSize = "Envelope #14, 5 x 11 1/2 in."
        Case 24
        ...
        Case 37
            pPaperSize = "Envelope Monarch, 3 7/8 x 7 1/2 in."
        Case 38
            pPaperSize = "Envelope, 3 5/8 x 6 1/2 in."
        Case 39
            pPaperSize = "U.S. Standard Fanfold, 14 7/8 x 11 in."
        Case 40
            pPaperSize = "German Standard Fanfold, 8 1/2 x 12 in."
        Case 41
            pPaperSize = "German Legal Fanfold, 8 1/2 x 13 in."
        Case 42 To 49
